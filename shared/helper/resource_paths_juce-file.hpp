...
namespace ResourcePaths {
    ...
    juce::File getLogsDirectory() {
        return juce::File::getSpecialLocation(juce::File::SpecialLocationType::userApplicationDataDirectory).getChildFile("ear-production-suite").getChildFile("logs");
    }

    juce::File getSettingsDirectory() {
        return juce::File::getSpecialLocation(juce::File::SpecialLocationType::userApplicationDataDirectory).getChildFile("ear-production-suite");
    }
}